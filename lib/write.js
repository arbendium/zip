...
/**
 * @param {Omit<
 *   Awaited<ReturnType<typeof readLocalFileHeader>>,
...
/**
 * @param {Omit<
 *   Awaited<ReturnType<typeof readDataDescriptor>>,
...
/**
 * @param {Omit<
 *   Awaited<ReturnType<typeof readCentralDirectoryFileHeader>>,
 *   'fileNameLength' | 'extraFieldsLength' | 'commentLength'
 * >} object
 * @returns {Buffer}
 */
...
/**
 * @param {Omit<
 *   Awaited<ReturnType<typeof readEndOfCentralDirectoryRecord>>,
 *   'commentLength'
 * >} object
 * @returns {Buffer}
 */
export function serializeEndOfCentralDirectoryRecord(object) {
	...
	buffer.writeUInt16LE(object.comment.length, 20);
...
/**
 * @param {Omit<
 *   Awaited<ReturnType<typeof readZip64EndOfCentralDirectoryRecord>>,
...
/**
 * @param {Awaited<
 *   ReturnType<typeof readZip64EndOfCentralDirectoryLocator>
 * >} object
 * @returns {Buffer}
 */
