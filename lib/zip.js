 ...
 * @import { Entry } from './zip.js'
 * @import { Entry as UnzipEntry } from './unzip.js'
 */
...
export default class Zip extends Readable {
	...
	addFile(realPath, fileName, {
		...
		/** @type {Promise<[FileHandle, BigIntStats]>} */
 ...
 *   | Promise<[Entry, () => void | Promise<void>]>
 * )} callback
 * @returns {Promise<Entry>}
 */
